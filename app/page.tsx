...
export default async function Home() {
  ...
  return (
    <div className="prose mx-auto lg:prose-lg prose-neutral prose-p:text-balance prose-headings:text-balance prose-invert py-4">
      <header className="flex gap-x-8 items-center">
        ...
        <div>
          ...
          <div className="flex flex-col">
            ...
            <a href="https://www.linkedin.com/in/andelkocvjekovic/">linkedin</a>
          </div>
        </div>
      </header>
